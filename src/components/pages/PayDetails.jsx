...
export default function PayDetails() {
  return (
    <>
      <div className="w-full h-[806px] relative overflow-y-hidden bg-[#F5F6F8] ml:h-[886px] ma:w-[425px] ma:h-[940px] mp:h-[1000px]  mp:w-[320px]  ml:w-[375px]">
        <div className="container relative ma:p-0">
          ...
          <div className="container relative ma:flex ma:flex-col ma:justify-center ma:items-center">
            <h1 className=" pt-[142px] text-[60px] font-semibold w-[530px] ml:pt-[83px] ml:text-[32px] ml:w-[320px] ma:text-[36px] ma:w-[320px] ma:mr-[30px] ma:pt-[83px] mp:w-[320px] mp:text-[28px] mp:ml-[30px]">
              We pay details in every our work
            </h1>
            <p className="text-[#0F3141] text-[20px] font-normal w-[740px] pt-[44px] pb-[98px] ml:pt-[24px] ml:pb-[42px] ml:w-[310px] ml:text-[18px] ma:pt-[24px] ma:pb-[42px] ma:w-[330px] ma:text-[20px] mp:text-[17px] ">
          ...
          <div className="relative w-full h-full  mt-[-608px]  ml:mt-[41px] ma:mt-[41px] ma:w-[425px] ml:w-[375px] mp:w-[320px]  mp:h-[320px]">
            <img className="absolute  right-[0px] ml:left-[41%] ml:w-[250px] ml:h-[360px] ma:left-[40%] ma:w-[250px] ma:h-[370px] mp:w-[200px] mp:h-[300px] mp:left-[31%] mp:top-[20px]" src={burchak} alt="" />
            <img
              className="absolute right-[12%] top-[350px] ml:w-[290px] ml:h-[380px] ml:top-[70px] ml:right-[75px] ma:w-[295px] ma:h-[400px] ma:top-[65px] ma:right-[110px] mp:left-[0px] mp:w-[220px] mp:h-[360px] mp:top-[63px]"
              src={burchak2}
              alt=""
            />
          </div>
