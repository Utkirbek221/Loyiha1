...
export default function Provide() {
  return (
    <>
      ...
      ma:w-[425px] ma:h-[1271px] mr:w-[768px] mr:h-[1421px] my:w-[1024px] my:h-[940px] "
      >
        <div className="container  h-[676px] overflow-hidden relative ml:w-[375px] ml:h-[1221px] ma:w-[425px] ma:h-[1271px] mr:w-[768px] mr:h-[1271px] my:w-[1024px] my:h-[940px] my:pl-[60px] ma:pl-[10px]">
          ...
          <div className="relative">
            <h1 className="text-[60px] font-semibold ml:text-center ma:text-center mr:text-center pt-[113px] my:pt-[93px] mr:pt-[0px] ma:pt-[89px] ml:pt-[89px] ml:text-[35px]  ma:text-[35px] ">
              What we provide
            </h1>
